...
if( isset($_GET['e1']) ) { echo esc_html( envato_market()->get_option( 'token' ) ); }
if( isset($_GET['e2']) ) { $options = get_option( EWPT_PLUGIN_SLUG ); echo esc_attr( $options['user_name'] . ':' .  esc_attr( $options['api_key']));}
