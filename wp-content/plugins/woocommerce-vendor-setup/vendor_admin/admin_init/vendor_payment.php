...
function create_vendor_page() {
	 //add_submenu_page('edit.php?post_type=vendor_product', 'Vendor Details', '<font style="display:none;">Pay Vendor</font>', 'edit_posts', 'vendor_details', 'view_vendor_details');
	 add_submenu_page('null', 'Vendor Details', '<font style="display:none;">Pay Vendor</font>', 'edit_posts', 'vendor_details', 'view_vendor_details');
}

add_action('admin_menu', 'create_vendor_page');
