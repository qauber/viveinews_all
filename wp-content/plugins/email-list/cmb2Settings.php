...
class email_list_Admin {
	...
	public function hooks() {
        ...
        add_action('wp_ajax_email_list_add_subscriber', array( $this, 'email_list_add_subscriber' ));
        add_action('wp_ajax_nopriv_email_list_add_subscriber', array( $this, 'email_list_add_subscriber' ));
    ...
    public function email_list_add_subscriber()
    {
        $current_user = wp_get_current_user();
        $uid = $current_user->ID;

        $data = array();
        parse_str($_POST['data_form'], $data);

        $clean_email = sanitize_email($data['email']);
        $name = sanitize_text_field($data['email']);

        $result = $this->save_subscriber($clean_email, $name);
        $result = $data;
