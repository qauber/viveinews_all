...
1. Upload `email list` to the `/wp-content/email list/` directory
1. Activate the email list through the 'Email List' menu in WordPress
1. Click **Email List** on the admin menu to enable and set your options.
...
You can't change the smtp through the email list plugin. The plugin uses the same smtp as wp_mail.

= Can I add subscribers to the email list via a link? =
Yes, you can add subscribers to the email list via a link?


== Screenshots ==

[See screenshots at thinklandingpages.com](http://www.thinklandingpages.com/email_list/)
