...
<div class="yith-ajaxsearchform-container yith_woocommerce_ajax_search">
    <form role="search" method="get" id="yith-ajaxsearchform" action="<?php echo esc_url( home_url( '/'  ) ) ?>">
        <div>
            ...
            <input type="search"
                   ...
                   pattern=".{<?php echo get_option('yith_wcas_min_chars'); ?>,}"
                   title="Minimum of 3 characters for search" />

            <button class="btn btn-info" type="submit" id="yith-searchsubmit" value="Search"><?php echo get_option('yith_wcas_search_submit_label') ?></button>
