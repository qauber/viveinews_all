jQuery(document).ready(function(b){var a=b(".yith-s"),c="undefined"!=typeof woocommerce_params&&"undefined"!=typeof woocommerce_params.ajax_loader_url?woocommerce_params.ajax_loader_url:yith_wcas_params.loading,d=""==a.data("loader-icon")?c:a.data("loader-icon"),c=b("#yith-searchsubmit"),e=a.data("min-chars");c.on("click",function(){$('.w1000').html('Please enter search field under сategory');$('.woocommerce-pagination').remove();return""==b(this).closest("form").find(".yith-s").val()?!1:!0});0==a.length&&(a=b("#yith-s"));a.each(function(){var a=b(this),c="undefined"==typeof a.data("append-to")?
