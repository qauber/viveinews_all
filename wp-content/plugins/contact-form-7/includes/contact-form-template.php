...
function wpcf7_messages() {
	$messages = array(
		...
		'invalid_required_name' => array(
			'description'
				=> __( "There is a field that the sender must fill in", 'contact-form-7' ),
			'default'
				=> __( 'Your name is required.', 'contact-form-7' )
		),

		'invalid_required_sub' => array(
			'description'
				=> __( "There is a field that the sender must fill in", 'contact-form-7' ),
			'default'
				=> __( 'Subject is required.', 'contact-form-7' )
		),

		'invalid_required_email' => array(
			'description'
				=> __( "There is a field that the sender must fill in", 'contact-form-7' ),
			'default'
				=> __( 'Your Email is required.', 'contact-form-7' )
		),

		'invalid_required_area' => array(
			'description'
				=> __( "There is a field that the sender must fill in", 'contact-form-7' ),
			'default'
				=> __( 'Your Message is required.', 'contact-form-7' )
		)
