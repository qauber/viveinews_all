...
/*
Template Name: project default view other users
*/
global $wp_query;
                        ...
                        <div class="active" id="project-list-tab-auction">
                                ...
                                <?php 
                                        ...
                                        <div class="wb-content new-row">
                                            ...
                                            <form action="" method="POST" class="form-horizontal" enctype="multipart/form-data" id="view_settings_other_users" name='view_settings_other_users' autocomplete="off">
                                                <div class="col-sm-8">
