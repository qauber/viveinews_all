...
<div id="main-wrapper">
<!-- banner -->
<div data-vide-bg="<?php echo get_template_directory_uri(); ?>/video/banner_converted">
        <div class="center-container">
            ...
            <div class="container">
                <div class="logo animated wow zoomIn" data-wow-delay="900ms">
                    <h1><a href="<?php echo home_url('/login'); ?>">WELCOME TO<span>LIVEiNEWS</span><i>Your first source for eye-witness breaking news</i></a></h1>
                </div>
                <div class="start animated wow bounce" data-wow-delay="700ms">
                    <a href="<?php echo home_url('/login'); ?>" class="hvr-bounce-to-bottom scroll">Get Started</a>
                </div>
            </div>
        </div>
	</div>
