<article <?php post_class('blog-post'); ?> id="post-<?php the_ID(); ?>">
	...
	<div class="e-pagination">
		<br>
			...
			<p class="prev_post"><?php previous_post_link('<i class="fa fa-chevron-left"></i> %link','Previous Post');?></p>
			<p class="next_post"><?php next_post_link('%link <i class="fa fa-chevron-right"></i>','Next Post');?></p>
    </div>
