...
$args = array(
    ...
    'tax_query' => array(
        array(
            ...
            'field' => 'id',
            'terms' => $default_view_settings['sub_category_side2'] ? $default_view_settings['sub_category_side2'] : $default_view_settings['category_side2'] )),
    'meta_query' => array(
        array(
            'key' 		=> '_visibility',
...
?>
<h3 class="title"><span><?php echo get_product_cat_name($default_view_settings['sub_category_side1']); ?></span></h3>
