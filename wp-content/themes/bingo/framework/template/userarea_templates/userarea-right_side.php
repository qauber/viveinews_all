...
$args = array(
    ...
    'tax_query' => array(
        array(
            ...
            'field' => 'id',
            'terms' => $default_view_settings['sub_category_right_side'] ? $default_view_settings['sub_category_right_side'] : $default_view_settings['category_right_side'] )),
    'auction_arhive' => TRUE,
    'meta_query' => array(
        array(
            'key' 		=> '_visibility',
...
<div class="right span6">
    <h3 class="title">
        <a href="#" title="<?php echo get_product_cat_name($default_view_settings['sub_category_right_side']); ?>">
            <span><?php echo get_product_cat_name($default_view_settings['sub_category_right_side']) ?></span>
        </a></h3>
    <div class="row-fluid">
