				...
				<div class="row">
					<div class="col-sm-8">
                		...
                		<h3 class="archive-title"><?php
	                        if ( is_day() ) :
	                            printf( __( 'Daily Archives: %s', 'bingo' ), '<span>' . get_the_date() . '</span>' );
	                        elseif ( is_month() ) :
	                            printf( __( 'Monthly Archives: %s', 'bingo' ), '<span>' . get_the_date( _x( 'F Y', 'monthly archives date format', 'bingo' ) ) . '</span>' );
	                        elseif ( is_year() ) :
	                            printf( __( 'Yearly Archives: %s', 'bingo' ), '<span>' . get_the_date( _x( 'Y', 'yearly archives date format', 'bingo' ) ) . '</span>' );
	                        else :
	                            _e( 'Archives', 'bingo' );
	                        endif;
	                        ?>
